...
# Variables
reporte_file = 'high-stock-low-price-report.json'  # Nombre del archivo JSON de entrada
ListaElba_file = 'Lista_Elba_27082024_cantidades.json'  # Nombre del archivo JSON de cotización
