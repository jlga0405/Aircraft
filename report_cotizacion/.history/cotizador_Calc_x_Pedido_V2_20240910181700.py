...
# Variables
reporte_file = 'high-stock-low-price-report_01.json'  # Nombre del archivo del reporte generado por insomnia
ListaElba_file = 'list_Elba_06092024_cantidades.json'  # Nombre del archivo de la lista de elba
outputfile = 'List_Cotizador_06092024.xlsx'  # Nombre del archivo XLSX de salida
