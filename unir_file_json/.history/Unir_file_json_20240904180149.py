...
file_json2 = 'proponent_02.json'
file_json3 = 'proponent_03.json'
file_json1 = 'proponent_01.json'
file_json4 = 'proponent_04.json'
file_json5 = 'proponent_05.json'
file_json6 = 'proponent_06.json'
file_json7 = 'proponent_07.json'
file_json8 = 'proponent_08.json'

# Nombre del archivo JSON de salida
file_output = 'output_proponent_General.json'

# Nombre del archivo Excel de salida
excel_output = 'output_proponent_General.xlsx'
