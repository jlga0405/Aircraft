...
file_json2 = 'wencor_02.json'
file_json3 = 'wencor_03.json'
file_json1 = 'wencor_01.json'
file_json4 = 'wencor_04.json'
file_json5 = 'wencor_05.json'
file_json6 = 'wencor_06.json'
file_json7 = 'wencor_07.json'
file_json8 = 'wencor_08.json'

# Nombre del archivo JSON de salida
file_output = 'output_wencor_General.json'

# Nombre del archivo Excel de salida
excel_output = 'output_wencor_General.xlsx'
