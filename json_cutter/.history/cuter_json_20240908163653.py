...
if __name__ == "__main__":
    json_file_path = "output_Lista_1878_07092024_wencor_04.json"
    output_base_name = "output_Lista_1878_07092024_wencor_04_"  # Nombre base para los archivos de salida
