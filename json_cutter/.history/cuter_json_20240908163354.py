...
if __name__ == "__main__":
    json_file_path = "output_Lista_1878_07092024_wencor_02.json"
    output_base_name = "output_Lista_1878_07092024_wencor_02_"  # Nombre base para los archivos de salida
