...
if __name__ == "__mai___.":
    json_file_path = "output_Lista_1878_07092024_wencor_03.json"
    output_base_name = "output_Lista_1878_07092024_wencor_03.json"  # Nombre base para los archivos de salida
