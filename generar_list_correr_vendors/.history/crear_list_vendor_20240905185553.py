...
for correr_item in correr_list:
    ...
    if correr_partNumber_cleaned in vendor_data_cleaned:
        # Recuperar el producto y agregar el partNumber sin cambios desde list_correr
        product = vendor_data_cleaned[correr_partNumber_cleaned]
        product['partNumber'] = correr_item['partNumber']  # Mantener formato original de list_correr
