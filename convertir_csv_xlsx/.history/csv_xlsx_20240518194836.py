...
if __name__ == "__main__":
    ...
    csv_file = "reporte_price_stock_quimicos_consumibles_lubricantes_completo_actual_areglada_17052024.csv"
    # Nombre del archivo XLSX de salida
    xlsx_file = "reporte_price_stock_quimicos_consumibles_lubricantes_completo_actual_areglada_17052024.xlsx"
