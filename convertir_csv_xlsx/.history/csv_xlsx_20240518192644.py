...
if __name__ == "__main__":
    ...
    csv_file = "volutionPriceOutput-list_Wencor_si_existVolutio_07a10_16052024.csv"
    # Nombre del archivo XLSX de salida
    xlsx_file = "volutionPriceOutput-list_Wencor_si_existVolutio_07a10_16052024.xlsx"
